...
from marshy.marshaller.json_str_marshaller import ExternalTypeMarshaller, ExternalItemTypeMarshaller, \
    OptionalExternalItemTypeMarshaller
from marshy.marshaller.marshaller_abc import MarshallerABC
from marshy.marshaller.no_op_marshaller import NoneMarshaller
from marshy.marshaller.primitive_marshaller import FloatMarshaller, IntMarshaller, StrMarshaller

priority = 100


def configure(context: InjectyContext):
    context.register_impls(MarshallerABC, [
        FloatMarshaller,
        IntMarshaller,
        StrMarshaller,
        UuidMarshaller,
    ...
    context.register_impls(MarshallerFactoryABC, [
